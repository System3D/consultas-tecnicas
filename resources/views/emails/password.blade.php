                    ...
                    <tr>
                        <td>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="center" style="font-size: 32px; font-family: Helvetica, Arial, sans-serif; color: #333333; padding-top: 30px;" class="padding-copy">Redefinição de senha</td>
                                </tr>
                                <tr>
                                    <td align="center" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">
										Olá {{ $user->name }}.<br/>
										Recebemos uma solicitação para alterar a sua senha.<br/>
										Para definir uma nova senha clique aqui:<br/>
										<a href="{{ url('password/reset/'.$token) }}" style="padding: 13px 20px;font-size:18px;font-family:Helvetica,Arial,sans-serif;color:#fff;background:#4285f4;text-decoration: none;margin: 20px;line-height: 60px;border-radius: 3px;"> Redefinir Senha </a>
                                    </td>
                                </tr>
                            </table>
                        </td>
