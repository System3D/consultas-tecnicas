...
class Client extends Model {
	...
	protected $fillable = array('id', 'email', 'name', 'company', 'responsavel', 'email2', 'cep', 'address', 'phones', 'slug', 'owner_id');
	protected $visible = array('id', 'email', 'name', 'company', 'responsavel', 'email2', 'cep', 'address', 'phones', 'slug', 'owner_id');
