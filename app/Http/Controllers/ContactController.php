...
class ContactController extends Controller {
   ...
   {   	
	...
	{		
		if( $request->ajax() ) 	return view('contacts.create-modal', compact('client_id', 'request'));		
		else 					return view('contacts.create', compact('client_id', 'request'));		
	}
	...
	public function edit(Request $request, $id)
	{
		...
		if( $contact ){						
			if( $request->ajax() ) 	return view('contacts.edit-modal', compact('contact'));			
			else 					return view('contacts.edit', compact('contact'));			
		}else{
