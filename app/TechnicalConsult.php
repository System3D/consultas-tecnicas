...
class TechnicalConsult extends Model {
	...
	protected $fillable = array( 'date', 'title', 'description', 'contact_id', 'project_id', 'project_stage_id', 'project_discipline_id', 'color', 'owner_id' );
	protected $visible 	= array( 'id', 'date', 'title', 'description', 'contact_id', 'project_id', 'project_stage_id', 'project_discipline_id', 'color', 'owner_id' );
